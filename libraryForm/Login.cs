...
namespace libraryForm
{
    public partial class Login : Form
    {
        ...
        {
         //   SecretQuestion sec = new SecretQuestion();
            //sec.ShowDialog();
            Login_Shown(forgotpasslab, EventArgs.Empty);
        }


        private void forgotpasslab_MouseLeave(object sender, EventArgs e)
        {
            forgotpasslab.ForeColor = Color.DeepSkyBlue;
        }
        ...
        private void forgotpasslab_MouseEnter(object sender, EventArgs e)
        {
            forgotpasslab.ForeColor = Color.SteelBlue;
        }
    }
